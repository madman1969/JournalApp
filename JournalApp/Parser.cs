...
namespace JournalApp.Parser
{
    public class Parser
    {
        ...
        public static List<JournalEntry> RetrieveJournalEntriesFromJSONFile(string jsonFile)
        {
            ...
            var input = Path.Combine(jsonFile.GetExecutingDirectoryName(), jsonFile);
        ...
        public static void WriteJSONFile(string jsonFile, List<JournalEntry> entryList)
        {
            ...
            var output = Path.Combine(jsonFile.GetExecutingDirectoryName(), jsonFile);
            ...
            var fileSize = output.GetFileSize() / 1024;
